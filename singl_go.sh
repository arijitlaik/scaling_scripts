...
export IMAGE='docker://underworldcode/underworld2:v2.8_release'
...
srun -n ${SLURM_NTASKS} singularity exec --pwd $PWD $IMAGE  bash -c "TIME_LAUNCH_PYTHON=\`date +%s%N | cut -b1-13\` python rt_timed.py"
